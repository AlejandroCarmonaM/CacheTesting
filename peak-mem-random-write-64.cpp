...
// This function writes data from an array in a random manner, following the indices stored in the elements of the array
...
int main(int argc, char **argv)
{
  ...
  printf("Benchmark: Random writes 64 bits\n");
